 ...
 */
package uk.ac.leeds.ccg.agdt.grids.core.chunk;
 ...
 * @version 1.0.0
 */
public abstract class Grids_ChunkNumber 
        extends Grids_Chunk 
        implements Grids_StatsInterface {
    
    protected Grids_ChunkNumber() {
    }

    protected Grids_ChunkNumber(Grids_Grid g,
