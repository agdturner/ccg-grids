 ...
 */
package uk.ac.leeds.ccg.agdt.grids.core.chunk.b;
 ...
 * @version 1.0.0
 */
public class Grids_ChunkFactoryBoolean
        extends Grids_ChunkFactory {

    public Grids_ChunkFactoryBoolean() {
    }

    public Grids_ChunkBoolean create(Grids_GridBoolean grid,
            Grids_2D_ID_int chunkID) {
        return new Grids_ChunkBoolean(grid, chunkID);
    }

    public Grids_ChunkBoolean create(Grids_ChunkBoolean chunk,
            Grids_2D_ID_int chunkID) {
        return new Grids_ChunkBoolean(chunk.getGrid(), chunkID);
    }
