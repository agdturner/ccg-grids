...
public class Grids_GridBoolean extends Grids_Grid {
     ...
     */
    protected Grids_GridBoolean(Generic_Path dir, Generic_Path gridFile,
     ...
     *
     * @param stats The Grids_StatsBoolean to accompany this.
     ...
     * @throws java.lang.ClassNotFoundException If encountered.
     */
    protected Grids_GridBoolean(Grids_Environment ge, Generic_Path dir,
            Generic_Path gridFile, double v) throws IOException, ClassNotFoundException {
        super(ge, dir);
        init(new Grids_StatsNotUpdatedBoolean(ge), gridFile, v);
    }
     ...
     * Initialises this.
     *
     * @param g The Grids_GridBoolean from which the fields of this are set. with
 those of g.
     * @throws java.io.IOException If encountered.
     */
    private void init(Grids_GridBoolean g) throws IOException {
//        Grids_StatsBoolean gStats;
//        gStats = g.getStats();
//        if (gStats instanceof Grids_StatsNotUpdatedBoolean) {
//            stats = new Grids_StatsNotUpdatedBoolean(this);
//        } else {
...
//        }
    ...
    private void init(Generic_Path file, ObjectInputStream ois) throws IOException, ClassNotFoundException {
        ...
        try {
            init((Grids_GridBoolean) ois.readObject());
            ois.close();
            ...
            try {
                ...
                Grids_GridFactoryInt gif = new Grids_GridFactoryInt(env,
                ...
                Grids_GridInt gi = gif.create(gid, file, ois);
                Grids_GridFactoryBoolean gbf = new Grids_GridFactoryBoolean(env,
                        gp.chunkBinaryFactory, gi.getChunkNRows(),
                        gi.getChunkNCols(), gi.getDimensions(), 
                        new Grids_StatsNotUpdatedBoolean(env),
                        DefaultValue);
                Grids_GridBoolean gd = (Grids_GridBoolean) gbf.create(this.dir, gi);
                init(gd);
                // Delete gi
                Files.delete(gid.getPath());
        ...
        if (getStats() == null) {
            stats = new Grids_StatsNotUpdatedBoolean(env);
        }
        stats.setGrid(this);
        init();
    }
     ...
     * @throws java.io.IOException If encountered.
     */
    private void init(Grids_StatsBoolean stats, Generic_Path directory,
            Grids_ChunkFactoryBoolean chunkFactory, int chunkNRows,
            int chunkNCols, long nRows, long nCols, Grids_Dimensions dimensions)
            throws IOException {
        env.checkAndMaybeFreeMemory();
        dir = directory;
    ...
    private void init(Grids_StatsBoolean stats, Grids_Grid g,
        ...
        if (g instanceof Grids_GridBoolean) {
            Grids_GridBoolean gd = (Grids_GridBoolean) g;
            Grids_ChunkBoolean c;
            boolean gValue;
    ...
    private void init(Grids_StatsBoolean stats, Generic_Path gridFile,
        ...
        if (Files.isDirectory(gridFile)) {
            if (true) {
                ...
                Grids_GridBoolean g = gf.create(dir, thisFile, ois);
...
//        return false;
     ...
     * @param value
     */
    protected void initCell(Grids_ChunkBoolean chunk,
    ...
    public void initCells(boolean value) throws IOException {
        ...
        while (ite.hasNext()) {
            ...
            Grids_ChunkBoolean chunk = (Grids_ChunkBoolean) chunkIDChunkMap.get(chunkID);
    ...
    /**
     * @return A Grids_GridIteratorBoolean for iterating over the cell values in
 this.
     */
    public Grids_GridIteratorBoolean iterator() throws IOException, ClassNotFoundException {
