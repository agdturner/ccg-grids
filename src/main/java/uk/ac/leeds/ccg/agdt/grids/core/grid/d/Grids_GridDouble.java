...
//        }
    ...
    private void init(Generic_Path file, ObjectInputStream ois) throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            Iterator<Grids_Chunk> ite = chunkIDChunkMap.values().iterator();
            while (ite.hasNext()) {
                Grids_Chunk chunk = ite.next();
                chunk.setGrid(this);
            }
            ...
            try {
                ...
                Grids_GridFactoryDouble gdf = new Grids_GridFactoryDouble(env,
                        ...
                        gp.DefaultGridChunkDoubleFactory, gi.getNoDataValue(),
                        gi.getChunkNRows(), gi.getChunkNCols(), gi.getDimensions(),
                        new Grids_StatsNotUpdatedDouble(env));
                Grids_GridDouble gd = (Grids_GridDouble) gdf.create(dir, gi);
                init(gd);
                // Delete gi
                Files.delete(idir.getPath());
        ...
        if (getStats() == null) {
            stats = new Grids_StatsNotUpdatedDouble(env);
        }
        stats.setGrid(this);
        init();
    }
