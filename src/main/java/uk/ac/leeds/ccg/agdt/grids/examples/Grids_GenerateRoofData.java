...
public class Grids_GenerateRoofData extends Grids_Processor {
    ...
    public static void main(String[] args) {
        try {
            Grids_GenerateRoofData p = new Grids_GenerateRoofData();
...
//    }
     ...
     * http://www.geog.leeds.ac.uk/people/a.turner/src/agdt/java/grids/dist/javadoc/uk/ac/leeds/ccg/agdt/grids/examples/Grids_GenerateRoofData.html#createHippedRoofs
     * file:///C:/Work/src/agdt/java/grids/dist/javadoc/uk/ac/leeds/ccg/agdt/grids/examples/Grids_GenerateRoofData.html#createHippedRoofs
     *
     * @param nrows .This is the number of rows in the grid
     * @param ncols .This is the number of columns in the grid
    ...
    public void createHippedRoofs(long nrows, long ncols, double halfCellsize,
        ...
        g.setName("HippedRowRidgedRoof_" + nrows + "_" + ncols + "_"
                + rowRidgeHeight + "_" + rowWithRidge + "_" + colStartRidge
                + "_" + colEndRidge);
        output(g, files.getOutputDir(), ImageExporter, ImageTypes,
                ESRIAsciiGridExporter);
        // Col ridged roofs
        for (row = 0; row < nrows; row++) {
            for (col = 0; col < ncols; col++) {
     ...
     * http://www.geog.leeds.ac.uk/people/a.turner/src/agdt/java/grids/dist/javadoc/uk/ac/leeds/ccg/agdt/grids/examples/Grids_GenerateRoofData.html#resize
