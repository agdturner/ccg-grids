 ...
 */
public class Grid2DSquareCellDoubleChunkArrayIterator extends AbstractIterator {
    ...
    public Grid2DSquareCellDoubleChunkArrayIterator() {}
     ...
     */
    public Grid2DSquareCellDoubleChunkArrayIterator( Grid2DSquareCellDoubleChunkArray grid2DSquareCellDoubleChunkArray ) {
        this.data = grid2DSquareCellDoubleChunkArray.getData();
        this.chunkRowIndex = 0;
        this.chunkColIndex = 0;
        Grid2DSquareCellDouble grid2DSquareCellDouble = grid2DSquareCellDoubleChunkArray.getGrid2DSquareCellDouble();
        this.chunkNrows = grid2DSquareCellDouble.getChunkNRows( 
                grid2DSquareCellDoubleChunkArray._ChunkID,
