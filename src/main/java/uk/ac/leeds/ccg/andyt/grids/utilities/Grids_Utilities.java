...
//            System.out.println( "Warning: Returning Double.POSITIVE_INFINITY in uk.ac.leeds.ccg.grids.Grids_Utilities.getValueALittleBitLarger(double)." );
...
//            System.out.println( "Warning: Returning Double.NEGATIVE_INFINITY in uk.ac.leeds.ccg.grids.Grids_Utilities.getValueALittleBitSmaller(double)." );
