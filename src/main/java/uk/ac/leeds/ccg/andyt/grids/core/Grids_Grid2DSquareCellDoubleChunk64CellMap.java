 ...
 * Grids_AbstractGrid2DSquareCellDoubleChunk extension that stores cell values in a 
 ...
 Grids_AbstractGrid2DSquareCellDoubleChunk is 64 cells.
 TODO:
...
public class Grids_Grid2DSquareCellDoubleChunk64CellMap 
    ...
    protected long powerOf2( 
        ...
        try {
            ...
            Grids_AbstractGrid2DSquareCell._UnsignedLongPowersOf2 = new Grids_UnsignedLongPowersOf2( false );
            //return this._UnsignedLongPowersOf2.powersOf2[ 63 - value ];
            return Grids_AbstractGrid2DSquareCell._UnsignedLongPowersOf2.powersOf2[ value ];
        }
    }
    ...
    /**
     * Returns a Grids_Grid2DSquareCellDoubleChunk64CellMapIterator for iterating over
 the cells in this.
     * @return 
     */
