...
import uk.ac.leeds.ccg.andyt.grids.core.AbstractGrid2DSquareCellFactory;
...
public class GenerateRoofData
     ...
     * @param _Directory
     */
    public GenerateRoofData(File _Directory) {
        super(_Directory);
    ...
    public static void main(String[] args) {
        try {
            ...
            GenerateRoofData _GenerateRoofData = new GenerateRoofData(_Directory);
    ...
    public void run_2()
        ...
        long _RowEndRidge;
        Grid2DSquareCellDouble _ResizedGrid2DSquareCellDouble = this._Grid2DSquareCellDoubleFactory.create(_Directory, _ResizedNRows, _ResizedNCols, _Dimensions, _Grids_Environment, _HandleOutOfMemoryError);
...
//                            for ( _ColRidgeHeight = 2; _ColRidgeHeight <= 8; _ColRidgeHeight *= 2 ) {
     ...
     * http://www.geog.leeds.ac.uk/people/a.turner/src/andyt/java/grids/dist/javadoc/uk/ac/leeds/ccg/andyt/grids/examples/GenerateRoofData.html#_AddRowRidge
     ...
     * http://www.geog.leeds.ac.uk/people/a.turner/src/andyt/java/grids/dist/javadoc/uk/ac/leeds/ccg/andyt/grids/examples/GenerateRoofData.html#_AddColRidge
     ...
     * http://www.geog.leeds.ac.uk/people/a.turner/src/andyt/java/grids/dist/javadoc/uk/ac/leeds/ccg/andyt/grids/examples/GenerateRoofData.html#_CreateHippedRoofs
     * file:///C:/Work/src/andyt/java/grids/dist/javadoc/uk/ac/leeds/ccg/andyt/grids/examples/GenerateRoofData.html#_CreateHippedRoofs
    ...
    public void _CreateHippedRoofs(
            Grid2DSquareCellDouble _ResizedGrid2DSquareCellDouble,
            long nrows,
            long ncols,
        ...
        Grid2DSquareCellDouble _Grid2DSquareCellDouble = (Grid2DSquareCellDouble) _Grid2DSquareCellDoubleFactory.create(nrows, ncols);
        long row;
        long col;
        // Row ridged roofs
        for (row = 0; row < nrows; row++) {
     ...
     * http://www.geog.leeds.ac.uk/people/a.turner/src/andyt/java/grids/dist/javadoc/uk/ac/leeds/ccg/andyt/grids/examples/GenerateRoofData.html#_CreateGableRoofs
...
//            }
            ...
            // Rescale
            Grid2DSquareCellDouble _AggregatedGrid2DSquareCellDouble = rescale(
                    _ResizedGrid2DSquareCellDouble,
                    null,
                    1.0d,
                    10.0d,
     ...
     * @return 
     **/
    public Grid2DSquareCellDouble disaggregate(
        ...
        Grid2DSquareCellDouble result = (Grid2DSquareCellDouble) _Grid2DSquareCellFactory.create(
                _NRows,
                _NCols,
                _Dimensions);
        long row;
     ...
     * http://www.geog.leeds.ac.uk/people/a.turner/src/andyt/java/grids/dist/javadoc/uk/ac/leeds/ccg/andyt/grids/examples/GenerateRoofData.html#_Resize
     ...
     */
    public void _Resize(
            Grid2DSquareCellDouble _ResizeGrid2DSquareCell,
            Grid2DSquareCellDouble _Grid2DSquareCellDouble,
            boolean _HandleOutOfMemoryError) {
        long _NRows = _Grid2DSquareCellDouble.get_NRows(_HandleOutOfMemoryError);
