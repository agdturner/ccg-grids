...
//    protected HashSet _AbstractGrid2DSquareCell_HashSet;
     ...
     */
    private AbstractGridStatistics _GridStatistics;
    /**
...
//    }
    ...
    public AbstractGridStatistics get_GridStatistics() {
        if (this._GridStatistics.getClass() == GridStatistics0.class) {
            return new GridStatistics0();
        }
        if (this._GridStatistics.getClass() == GridStatistics1.class) {
            return new GridStatistics1();
        }
    ...
    public AbstractGrid2DSquareCell create(
            ...
            BigDecimal[] _Dimensions) {
        return create(
                FileCreator.createNewFile(this._Directory),
                _NRows,
                _NCols,
                _Dimensions);
    }
    ...
    public AbstractGrid2DSquareCell create(
        ...
        //this._Directory = FileCreator.createNewFile( new File( _DirectoryName ) );
