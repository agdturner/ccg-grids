...
public class Grid2DSquareCellDoubleChunkMap 
     ...
     * 
     * 
     * @param chunkCellID the AbstractGrid2DSquareCellDoubleChunk.ChunkCellID of
    ...
    /**
     * Returns a Grid2DSquareCellDoubleChunkMapIterator for iterating over
     * the cells in this.
     * @return 
     */
    protected @Override AbstractIterator iterator() {
        return new Grid2DSquareCellDoubleChunkMapIterator( this );
    }
