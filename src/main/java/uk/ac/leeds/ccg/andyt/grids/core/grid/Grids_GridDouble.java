...
public class Grids_GridDouble
    ...
    protected Grids_GridDouble(
            ...
            boolean hoome) {
        super(ge, directory);
        init(new Grids_GridDoubleStatsNotUpdated(ge), gridFile, hoome);
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Grids_GridInt gi;
                    gi = (Grids_GridInt) gif.create(Directory, file, ois,
                            hoome);
                    ...
                    gdf = new Grids_GridDoubleFactory(ge,
                            ...
                            gi.NoDataValue, gi.ChunkNRows,
                            gi.ChunkNCols, gi.Dimensions,
                            new Grids_GridDoubleStatsNotUpdated(ge));
                    Grids_GridDouble gd;
                    gd = (Grids_GridDouble) gdf.create(gi);
                    boolean initTransientFields = false;
...
//                Grids_GridChunkDouble gridChunk;
                ...
                if (gridFileNoDataValue == NoDataValue) {
                    if (stats.getClass().getName().equalsIgnoreCase(Grids_GridDoubleStats.class.getName())) {
    ...
    private void init(
        ...
        if (gridFile.isDirectory()) {
            if (true) {
                ...
                ois = Generic_StaticIO.getObjectInputStream(thisFile);
                Grids_GridDouble g;
                g = (Grids_GridDouble) gf.create(Directory, thisFile, ois, hoome);
                init(g);
            }
            initChunks(gridFile);
        } else {
     ...
     */
    @Override
    public final Grids_AbstractGridChunkDouble getGridChunk(int chunkRow,
            int chunkCol) {
...
//        return NoDataValue;
    ...
    public void setCell(
        ...
        int cellCol = getCellCol(col);
        Grids_AbstractGridChunkDouble chunk;
        chunk = (Grids_AbstractGridChunkDouble) getGridChunk(chunkRow, chunkCol);
