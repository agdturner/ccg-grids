...
public class Grid2DSquareCellDoubleChunkJAI
    ...
    /**
     * Creates a new Grid2DSquareCellDoubleChunkJAI from a  
     * AbstractGrid2DSquareCellDoubleChunk with _ChunkID ChunkID
     * 
     * 
     * 
    ...
    /**
     * Returns a Grid2DSquareCellDoubleChunkJAIIterator for iterating over
     * the cells in this.
     * @return 
     */
    protected @Override AbstractIterator iterator() {
        return new Grid2DSquareCellDoubleChunkJAIIterator( this );
    }
