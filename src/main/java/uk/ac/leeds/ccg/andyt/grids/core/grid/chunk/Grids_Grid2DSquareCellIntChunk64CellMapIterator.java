 ...
 */
public class Grids_Grid2DSquareCellIntChunk64CellMapIterator 
    ...
    public Grids_Grid2DSquareCellIntChunk64CellMapIterator() {}
    ...
    public Grids_Grid2DSquareCellIntChunk64CellMapIterator(
        ...
        long chunkNrows = ( long ) grid2DSquareCellInt.getChunkNRows(grid2DSquareCellIntChunk64CellMap.ChunkID, 
                ge.HandleOutOfMemoryErrorFalse );
        long chunkNcols = ( long ) grid2DSquareCellInt.getChunkNCols(grid2DSquareCellIntChunk64CellMap.ChunkID, 
                ge.HandleOutOfMemoryErrorFalse );
