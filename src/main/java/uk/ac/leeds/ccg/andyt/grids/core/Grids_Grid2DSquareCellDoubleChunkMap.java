 ...
 */
public class Grids_Grid2DSquareCellDoubleChunkMap 
     ...
     * By default the defaultValue is set to this._Grid2DSquareCell.getNoDataValue().
     */
    private double defaultValue;
    
    /**
     * For storing values mapped to a Grids_2D_ID_int HashSet or an individual Grids_2D_ID_int.
     */
    ...
    protected Grids_Grid2DSquareCellDoubleChunkMap( 
        ...
        this( 
                ...
                _ChunkID, 
                grid2DSquareCellDouble._NoDataValue );
    }
    ...
    protected @Override double[] toArrayIncludingNoDataValues() {
        ...
        TDoubleObjectHashMap data = getData();
     ...
     * 
     * 
     * @param chunkCellID the Grids_AbstractGrid2DSquareCellDoubleChunk.Grids_2D_ID_int of
   ...
   the cell to be initialised
    ...
    /**
     * Returns a Grids_Grid2DSquareCellDoubleChunkMapIterator for iterating over
 the cells in this.
     * @return 
     */
    protected @Override Grids_AbstractIterator iterator() {
        return new Grids_Grid2DSquareCellDoubleChunkMapIterator( this );
    }
