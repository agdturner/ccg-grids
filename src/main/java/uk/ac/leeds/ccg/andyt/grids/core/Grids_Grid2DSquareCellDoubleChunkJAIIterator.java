 ...
 */
public class Grids_Grid2DSquareCellDoubleChunkJAIIterator extends Grids_AbstractIterator {
    ...
    public Grids_Grid2DSquareCellDoubleChunkJAIIterator() {}
     ...
     *   to iterate over.
     */
    public Grids_Grid2DSquareCellDoubleChunkJAIIterator(Grids_Grid2DSquareCellDoubleChunkJAI grid2DSquareCellDoubleChunkJAI) {
        this.data = grid2DSquareCellDoubleChunkJAI.getData();
        this.chunkRowIndex = 0;
        this.chunkColIndex = 0;
        Grids_Grid2DSquareCellDouble grid2DSquareCellDouble = grid2DSquareCellDoubleChunkJAI.getGrid2DSquareCellDouble();
