...
public abstract class AbstractGrid2DSquareCellDoubleChunk
     ...
     * @return ( Grid2DSquareCellDouble )
     * this._Grid2DSquareCell._Grids_Environment.
     */
    public Grid2DSquareCellDouble getGrid2DSquareCellDouble(
            boolean handleOutOfMemoryError) {
        try {
            Grid2DSquareCellDouble result = getGrid2DSquareCellDouble();
    ...
    protected Grid2DSquareCellDouble getGrid2DSquareCellDouble() {
        return (Grid2DSquareCellDouble) this._Grid2DSquareCell;
    }
    ...
    public double getCell(
        ...
        try {
            ...
            if (handleOutOfMemoryError) {
                this._Grid2DSquareCell._Grids_Environment.clear_MemoryReserve();
                if (this._Grid2DSquareCell._Grids_Environment.swapToFile_Grid2DSquareCellChunkExcept_AccountDetail(chunkID, handleOutOfMemoryError) == null) {
