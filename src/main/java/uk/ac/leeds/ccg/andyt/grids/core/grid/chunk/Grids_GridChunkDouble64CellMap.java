 ...
 * TDoubleLongHashMap. The maximum size of this Grids_AbstractGridChunkDouble is
 * 64 cells. TODO: Adjudicate when this is useful. What type of data?
 */
public class Grids_GridChunkDouble64CellMap
    ...
    protected Grids_GridChunkDouble64CellMap() {
    }
    ...
    protected Grids_GridChunkDouble64CellMap(
        ...
        Long nCellsInChunk
                ...
                * (long) g.getChunkNCols(ChunkID, handleOutOfMemoryError);
        if (nCellsInChunk <= 64) {
            initData();
        } else {
            System.err.println(
    ...
    double getCell(
        ...
        TDoubleLongIterator iterator = this.data.iterator();
        Grids_UnsignedLong valueMap = new Grids_UnsignedLong();
        Grids_GridDouble grid2DSquareCellDouble = getGrid();
    ...
    protected long powerOf2(
            int value) {
        Grids_GridDouble grid2DSquareCellDouble = this.getGrid();
    ...
    /**
     * Returns a Grids_GridChunkDouble64CellMapIterator for iterating over the
     * cells in this.
     *
     * @return
     */
    ...
    Grids_AbstractIterator iterator() {
        return new Grids_GridChunkDouble64CellMapIterator(this);
    }
