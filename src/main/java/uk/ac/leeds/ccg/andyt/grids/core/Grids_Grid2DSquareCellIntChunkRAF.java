 ...
 * Grids_AbstractGrid2DSquareCellIntChunk extension that stores cell values in a
 RandomAccessFile.
 */
public class Grids_Grid2DSquareCellIntChunkRAF
     ...
     * Default constructor
     */
    public Grids_Grid2DSquareCellIntChunkRAF() {
     ...
     * @param chunkID
     */
    protected Grids_Grid2DSquareCellIntChunkRAF(
            File file,
    ...
    protected Grids_Grid2DSquareCellIntChunkRAF(
        ...
        initGrid2DSquareCell( grid2DSquareCellInt );
        if ( grid2DSquareCellIntChunk instanceof Grids_Grid2DSquareCellIntChunkRAF ) {
    ...
    /**
     * Returns a Grids_Grid2DSquareCellIntChunkRAFIterator for iterating over
 the cells in this.
     * @return 
     */
    @Override
    public Grids_AbstractIterator iterator() {
        return new Grids_Grid2DSquareCellIntChunkRAFIterator( this );
    }
