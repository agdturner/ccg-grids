...
public class Grid2DSquareCellDouble
     ...
     * @param directory The File _Directory to be used for swapping.
     * @param chunkFactory The AbstractGrid2DSquareCellDoubleChunkFactory
     ...
     * @param gridStatistics The AbstractGridStatistics to accompany this.
     * @param directory The File _Directory to be used for swapping.
     * @param grid The AbstractGrid2DSquareCell from which this is to be
     * constructed.
     * @param chunkFactory The AbstractGrid2DSquareCellDoubleChunkFactory
     ...
     * Grid2DSquareCellInt or a ESRI Asciigrid format file with a _Name ending
     * ".asc".
     *
     * @param gridStatistics The AbstractGridStatistics to accompany this.
     * @param directory The File _Directory to be used for swapping.
     ...
     * Initialises this.
     *
     * @param a_Grid2DSquareCellDouble The Grid2DSquareCellDouble from which the
    ...
    private void initGrid2DSquareCellDouble(
        ...
        if (initTransientFields) {
            this._Grids_Environment = a_Grid2DSquareCellDouble._Grids_Environment;
            ...
            //init_Grid2DSquareCells_MemoryReserve(a_Grid2DSquareCellDouble._Grids_Environment);
     ...
     * AbstractGrid2DSquareCell instances.
     * @param handleOutOfMemoryError If true then OutOfMemoryErrors are caught,
     * swap operations are initiated, then the method is re-called. If false
     * then OutOfMemoryErrors are caught and thrown.
    ...
    private void initGrid2DSquareCellDouble(
        ...
        try {
            ...
            try {
                ...
                initGrid2DSquareCellDouble(
                        (Grid2DSquareCellDouble) ois.readObject(),
                        initTransientFields);
                ois.close();
                // Set the reference to this in the Grid Chunks
                initGrid2DSquareCellChunks(grid_File);
                Iterator<AbstractGrid2DSquareCellChunk> chunkIterator;
                chunkIterator = this._ChunkID_AbstractGrid2DSquareCellChunk_HashMap.values().iterator();
                while (chunkIterator.hasNext()) {
                    AbstractGrid2DSquareCellChunk grid2DSquareCellChunkAbstract = chunkIterator.next();
                ...
                try {
                    ...
                    // If the object is a Grid2DSquareCellInt
                    Grid2DSquareCellIntFactory grid2DSquareCellIntFactory = new Grid2DSquareCellIntFactory(
                            _Directory,
                            _Grids_Environment,
                            handleOutOfMemoryError);
                    Grid2DSquareCellInt grid2DSquareCellInt = (Grid2DSquareCellInt) grid2DSquareCellIntFactory.create(
                            _Directory,
                            grid_File,
                            ois);
                    Grid2DSquareCellDoubleFactory grid2DSquareCellDoubleFactory = new Grid2DSquareCellDoubleFactory(
                            ...
                            _Grids_Environment,
                            handleOutOfMemoryError);
                    Grid2DSquareCellDouble grid2DSquareCellDouble = (Grid2DSquareCellDouble) grid2DSquareCellDoubleFactory.create(grid2DSquareCellInt);
                    boolean initTransientFields = false;
                    initGrid2DSquareCellDouble(
            ...
            if (handleOutOfMemoryError) {
                ...
                if (_Grids_Environment.swapToFile_Grid2DSquareCellChunks_Account() < 1L) {
                    throw a_OutOfMemoryError;
                }
                initGrid2DSquareCellDouble(
                        _Directory,
     ...
     * AbstractGrid2DSquareCellDoubleChunkFactory prefered for creating chunks.
     * @param chunkNRows The number of rows of cells in any chunk.
     * @param chunkNCols The number of columns of cells in any chunk.
     * @param nRows The number of rows of cells.
     * @param nCols The number of columns of cells.
    ...
    private void initGrid2DSquareCellDouble(
            ...
            boolean handleOutOfMemoryError) {
        try {
            this._Grids_Environment = grids_Environment;
            ...
            AbstractGrid2DSquareCellDoubleChunk _Grid2DSquareCellDoubleChunk = chunkFactory.createGrid2DSquareCellDoubleChunk(
                    this,
                    a_ChunkID);
            ...
            if (handleOutOfMemoryError) {
                ...
                _Grids_Environment = grids_Environment;
                if (_Grids_Environment.swapToFile_Grid2DSquareCellChunks_Account() < 1) {
                    throw a_OutOfMemoryError;
                }
                _Grids_Environment.init_MemoryReserve(handleOutOfMemoryError);
                initGrid2DSquareCellDouble(
    ...
    private void initGrid2DSquareCellDouble(
        ...
        try {
            ...
            String println = _Grids_Environment.initString(1000, handleOutOfMemoryError);
            ChunkID a_ChunkID = new ChunkID();
            AbstractGrid2DSquareCellDoubleChunk grid2DSquareCellDoubleChunk = chunkFactory.createGrid2DSquareCellDoubleChunk(
                    this,
                    a_ChunkID);
            AbstractGrid2DSquareCellChunk gridChunk;
            if (gridStatistics.getClass() == GridStatistics0.class) {
...
//                                        cellDouble = _Grid2DSquareCell.getCellDouble(
//                                                row,
//                                                col );
...
//                                }
     ...
     * @param chunkFactory The AbstractGrid2DSquareCellDoubleChunkFactory
     * prefered to construct chunks of this.
     * @param chunkNRows The Grid2DSquareCellDouble _ChunkNRows.
     * @param chunkNCols The Grid2DSquareCellDouble _ChunkNCols.
        ...
        try {
            ...
            if (gridFile.isDirectory()) {
                ...
                if (true) {
                    ...
                    try {
                        ois = new ObjectInputStream(
                                new BufferedInputStream(
                                        new FileInputStream(thisFile)));
                        Grid2DSquareCellDouble gridFileGrid2DSquareCellDouble = (Grid2DSquareCellDouble) grid2DSquareCellDoubleFactory.create(
                                directory,
                                thisFile,
                                ois);
                        Grid2DSquareCellDouble gridFileGrid2DSquareCell = grid2DSquareCellDoubleFactory.create(
                                directory,
                ...
                if (filename.endsWith("asc") || filename.endsWith("txt")) {
                    ESRIAsciiGridImporter _ESRIAsciigridImporter = new ESRIAsciiGridImporter(
                            gridFile,
                            _Grids_Environment);
     ...
     * then OutOfMemoryErrors are caught and thrown.
     */
    public AbstractGrid2DSquareCellDoubleChunk getGrid2DSquareCellDoubleChunk(
            int _ChunkRowIndex,
            int _ChunkColIndex,
            boolean handleOutOfMemoryError) {
        try {
            AbstractGrid2DSquareCellDoubleChunk result = getGrid2DSquareCellDoubleChunk(
                    _ChunkRowIndex,
                    _ChunkColIndex);
            _Grids_Environment.tryToEnsureThereIsEnoughMemoryToContinue(handleOutOfMemoryError);
            return result;
     ...
     * @return grid2DSquareCellDoubleChunks.
     */
    protected AbstractGrid2DSquareCellDoubleChunk getGrid2DSquareCellDoubleChunk(
            int _ChunkRowIndex,
            int _ChunkColIndex) {
        ChunkID a_ChunkID = new ChunkID(
                this._NChunkCols,
    ...
    public AbstractGrid2DSquareCellDoubleChunk getGrid2DSquareCellDoubleChunk(
            ...
            boolean handleOutOfMemoryError) {
        try {
            AbstractGrid2DSquareCellDoubleChunk result = getGrid2DSquareCellDoubleChunk(a_ChunkID);
            _Grids_Environment.tryToEnsureThereIsEnoughMemoryToContinue(handleOutOfMemoryError);
            return result;
        } catch (OutOfMemoryError a_OutOfMemoryError) {
            if (handleOutOfMemoryError) {
    ...
    protected AbstractGrid2DSquareCellDoubleChunk getGrid2DSquareCellDoubleChunk(
        ...
        if (isInGrid) {
            ...
            return (AbstractGrid2DSquareCellDoubleChunk) this._ChunkID_AbstractGrid2DSquareCellChunk_HashMap.get(a_ChunkID);
        }
        return null;
    }
     ...
     * statistics of GridStatistics1 type.
     *
    ...
    protected double getCell(
        ...
        if (isInGrid) {
            ...
            if (grid2DSquareCellChunk.getClass() == Grid2DSquareCellDoubleChunk64CellMap.class) {
                return ((Grid2DSquareCellDoubleChunk64CellMap) grid2DSquareCellChunk).getCell(
                        _ChunkCellRowIndex,
                        _ChunkCellColIndex,
                        _NoDataValue);
            } else {
                if (grid2DSquareCellChunk.getClass() == Grid2DSquareCellDoubleChunkArray.class) {
                    return ((Grid2DSquareCellDoubleChunkArray) grid2DSquareCellChunk).getCell(
                            _ChunkCellRowIndex,
                            _ChunkCellColIndex,
                            _NoDataValue);
                } else {
                    if (grid2DSquareCellChunk.getClass() == Grid2DSquareCellDoubleChunkJAI.class) {
                        return ((Grid2DSquareCellDoubleChunkJAI) grid2DSquareCellChunk).getCell(
                                _ChunkCellRowIndex,
                                _ChunkCellColIndex,
                                _NoDataValue);
                    } else {
                        return ((Grid2DSquareCellDoubleChunkMap) grid2DSquareCellChunk).getCell(
                                _ChunkCellRowIndex,
                                _ChunkCellColIndex,
                                _NoDataValue);
                    }
    ...
    protected double setCell(
        ...
        AbstractGrid2DSquareCellDoubleChunk grid2DSquareCellDoubleChunk = getGrid2DSquareCellDoubleChunk(
                _ChunkRowIndex,
                _ChunkColIndex);
        return setCell(
                grid2DSquareCellDoubleChunk,
    ...
    protected double setCell(
            ...
            int chunkCellColIndex,
            double newValue) {
        double result = get_NoDataValue(Grids_Environment.HandleOutOfMemoryErrorFalse);
        if (chunk.getClass() == Grid2DSquareCellDoubleChunk64CellMap.class) {
            result = ((Grid2DSquareCellDoubleChunk64CellMap) chunk).setCell(
                    chunkCellRowIndex,
                    chunkCellColIndex,
                    newValue,
                    result);
        } else {
            if (chunk.getClass() == Grid2DSquareCellDoubleChunkArray.class) {
                result = ((Grid2DSquareCellDoubleChunkArray) chunk).setCell(
                        chunkCellRowIndex,
                        chunkCellColIndex,
                        newValue,
                        result);
            } else {
                if (chunk.getClass() == Grid2DSquareCellDoubleChunkJAI.class) {
                    result = ((Grid2DSquareCellDoubleChunkJAI) chunk).setCell(
                            chunkCellRowIndex,
                            chunkCellColIndex,
                            newValue,
                            result);
                } else {
                    if (chunk.getClass() == Grid2DSquareCellDoubleChunkMap.class) {
                        result = ((Grid2DSquareCellDoubleChunkMap) chunk).setCell(
                                chunkCellRowIndex,
                                chunkCellColIndex,
                                newValue,
                                result);
        ...
        if (nearestValue == noDataValue) {
            ...
            while (!foundValue) {
                ...
                while (iterator.hasNext()) {
                    ...
                    value = getCell(cellID0, Grids_Environment.HandleOutOfMemoryErrorTrue);
            ...
            for (CellID cellID : cellIDs) {
                if (!visitedSet.contains(cellID)) {
                    if (getCell(cellID, Grids_Environment.HandleOutOfMemoryErrorTrue) != noDataValue) {
                        distance = Utilities.distance(x, y, getCellXDouble(cellID), getCellYDouble(cellID));
                        if (distance < minDistance) {
                            closest.clear();
                            closest.add(cellID);
                        } else {
        ...
        if (nearestCellValue == _NoDataValue) {
            ...
            for (CellID cellID1 : cellIDs) {
                if (!visitedSet.contains(cellID1)) {
                    if (getCell(cellID1, Grids_Environment.HandleOutOfMemoryErrorTrue) != _NoDataValue) {
                        distance = Utilities.distance(x, y, getCellXDouble(cellID1), getCellYDouble(cellID1));
                        if (distance < minDistance) {
                            closest.clear();
                            closest.add(cellID1);
                        } else {
    ...
    protected double getNearestValueDoubleDistance(
        ...
        if (result == noDataValue) {
            ...
            for (CellID cellID1 : cellIDs) {
                if (!visitedSet.contains(cellID1)) {
                    if (getCell(cellID1, Grids_Environment.HandleOutOfMemoryErrorTrue) != noDataValue) {
                        distance = Utilities.distance(x, y, getCellXDouble(cellID1), getCellYDouble(cellID1));
                        minDistance = Math.min(
                                minDistance,
                                distance);
    ...
    protected void init_Cells(double value) {
        ...
        while (a_Iterator.hasNext()) {
            ...
            a_Grid2DSquareCellDoubleChunk = (AbstractGrid2DSquareCellDoubleChunk) this._ChunkID_AbstractGrid2DSquareCellChunk_HashMap.get(a_ChunkID);
