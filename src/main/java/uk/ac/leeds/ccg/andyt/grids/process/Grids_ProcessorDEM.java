...
public class Grids_ProcessorDEM
    ...
    /**
     * A HashSet for storing Grids_AbstractGridNumber.CellIDs
     */
...
//                    weightFactor );
            ...
            slopeAndAspect[0] = (Grids_GridDouble) Grid2DSquareCellDoubleFactory.create(_File,
                    nrows,
                    ncols,
                    dimensions,
                    handleOutOfMemoryError);
            ...
            _Message = slopeAndAspect[0].toString(handleOutOfMemoryError);
            _Message = ge.println(_Message, _Message0, handleOutOfMemoryError);
            ...
            slopeAndAspect[1] = (Grids_GridDouble) Grid2DSquareCellDoubleFactory.create(_File,
                    nrows,
                    ncols,
                    dimensions,
                    handleOutOfMemoryError);
            ...
            _Message = slopeAndAspect[1].toString(handleOutOfMemoryError);
            _Message = ge.println(_Message, _Message0, handleOutOfMemoryError);
            ...
            _File = ge.initFileDirectory(directory, _Filename, handleOutOfMemoryError);
            Grid2DSquareCellDoubleFactory.setDirectory(_File);
            slopeAndAspect[2] = (Grids_GridDouble) Grid2DSquareCellDoubleFactory.create(_File,
                    nrows,
                    ncols,
                    dimensions,
                    handleOutOfMemoryError);
            ...
            _Message = slopeAndAspect[2].toString(handleOutOfMemoryError);
            _Message = ge.println(_Message, _Message0, handleOutOfMemoryError);
            ...
            _File = ge.initFileDirectory(directory, _Filename, handleOutOfMemoryError);
            Grid2DSquareCellDoubleFactory.setDirectory(_File);
            slopeAndAspect[3] = (Grids_GridDouble) Grid2DSquareCellDoubleFactory.create(_File,
                    nrows,
                    ncols,
                    dimensions,
                    handleOutOfMemoryError);
            ...
            _Message = slopeAndAspect[3].toString(handleOutOfMemoryError);
            _Message = ge.println(_Message, _Message0, handleOutOfMemoryError);
            ...
            _File = ge.initFileDirectory(directory, _Filename, handleOutOfMemoryError);
            Grid2DSquareCellDoubleFactory.setDirectory(_File);
            slopeAndAspect[4] = (Grids_GridDouble) Grid2DSquareCellDoubleFactory.create(_File,
                    nrows,
                    ncols,
                    dimensions,
                    handleOutOfMemoryError);
...
//                ioe0.printStackTrace();
            ...
            _Message = slopeAndAspect[4].toString(handleOutOfMemoryError);
            _Message = ge.println(_Message, _Message0, handleOutOfMemoryError);
            ...
            _File = ge.initFileDirectory(directory, _Filename, handleOutOfMemoryError);
            Grid2DSquareCellDoubleFactory.setDirectory(_File);
            slopeAndAspect[5] = (Grids_GridDouble) Grid2DSquareCellDoubleFactory.create(_File,
                    nrows,
                    ncols,
                    dimensions,
                    handleOutOfMemoryError);
            ...
            _Message = slopeAndAspect[5].toString(handleOutOfMemoryError);
            _Message = ge.println(_Message, _Message0, handleOutOfMemoryError);
            ...
            _File = ge.initFileDirectory(directory, _Filename, handleOutOfMemoryError);
            Grid2DSquareCellDoubleFactory.setDirectory(_File);
            slopeAndAspect[6] = (Grids_GridDouble) Grid2DSquareCellDoubleFactory.create(_File,
                    nrows,
                    ncols,
                    dimensions,
                    handleOutOfMemoryError);
            ...
            _Message = slopeAndAspect[6].toString(handleOutOfMemoryError);
            _Message = ge.println(_Message, _Message0, handleOutOfMemoryError);
            ...
            _File = ge.initFileDirectory(directory, _Filename, handleOutOfMemoryError);
            Grid2DSquareCellDoubleFactory.setDirectory(_File);
            slopeAndAspect[7] = (Grids_GridDouble) Grid2DSquareCellDoubleFactory.create(_File,
                    nrows,
                    ncols,
                    dimensions,
                    handleOutOfMemoryError);
            ...
            _Message = slopeAndAspect[7].toString(handleOutOfMemoryError);
            _Message = ge.println(_Message, _Message0, handleOutOfMemoryError);
            ...
            _File = ge.initFileDirectory(directory, _Filename, handleOutOfMemoryError);
            Grid2DSquareCellDoubleFactory.setDirectory(_File);
            slopeAndAspect[8] = (Grids_GridDouble) Grid2DSquareCellDoubleFactory.create(_File,
                    nrows,
                    ncols,
                    dimensions,
                    handleOutOfMemoryError);
            ...
            _Message = slopeAndAspect[8].toString(handleOutOfMemoryError);
            _Message = ge.println(_Message, _Message0, handleOutOfMemoryError);
            ...
            _File = ge.initFileDirectory(directory, _Filename, handleOutOfMemoryError);
            Grid2DSquareCellDoubleFactory.setDirectory(_File);
            slopeAndAspect[9] = (Grids_GridDouble) Grid2DSquareCellDoubleFactory.create(_File,
                    nrows,
                    ncols,
                    dimensions,
                    handleOutOfMemoryError);
            ...
            _Message = slopeAndAspect[9].toString(handleOutOfMemoryError);
            _Message = ge.println(_Message, _Message0, handleOutOfMemoryError);

            _Message = "Initialised Results";
            _Message = ge.println(_Message, _Message0, handleOutOfMemoryError);

            _Message = g.toString(handleOutOfMemoryError);
            _Message = ge.println(_Message, _Message0, handleOutOfMemoryError);

            if (g.getClass() == Grids_GridDouble.class) {
                gridDouble = (Grids_GridDouble) g;
                noDataValueDouble = gridDouble.getNoDataValue(handleOutOfMemoryError);
                    ...
                    for (cci = 0; cci < nChunkCols; cci++) {
                        ...
                        for (chunkCellRowIndex = 0; chunkCellRowIndex < chunkNrows; chunkCellRowIndex++) {
                            ...
                            for (chunkCellColIndex = 0; chunkCellColIndex < chunkNcols; chunkCellColIndex++) {
                                ...
                                heightDouble = chunkDouble.getCell(
                                        chunkCellRowIndex,
                                        chunkCellColIndex,
                                        noDataValueDouble,
                                        handleOutOfMemoryError);
                                    ...
                                    for (p = -cellDistance; p <= cellDistance; p++) {
                                        ...
                                        for (q = -cellDistance; q <= cellDistance; q++) {
                                            if (!(p == 0 && q == 0)) {
                                                ...
                                                thisDistance = distance(x, y, thisX, thisY, nChunkCols, cri, cci, handleOutOfMemoryError);
                                                if (thisDistance <= distance) {
                                                    thisHeightDouble = gridDouble.getCell(
                                                            thisX,
                                                            thisY,
                                                            handleOutOfMemoryError);
                            ...
                            for (chunkCellColIndex = 0; chunkCellColIndex < chunkNcols; chunkCellColIndex++) {
                                ...
                                if (boolean0) {
                                    ...
                                    if (numberObservations > 0) {
                                        ...
                                        double1 = y + diffY;
                                        angle = angle(x, y, double0, double1,
                                                nChunkCols, cri, cci, handleOutOfMemoryError);
                                        slopeAndAspect[1].setCell(
                                                cellRowIndex,
                                                cellColIndex,
                                                angle,
...
//            double weightIntersect,
//            double weightFactor,
//            Grids_GridDoubleFactory Grid2DSquareCellDoubleFactory,
//            Grids_GridIntFactory Grid2DSquareCellIntFactory,
//            boolean handleOutOfMemoryError )
//            throws IOException {
//        try {
//            ge.getGrids().add( _Grid2DSquareCell );
...
//                    try {
//                        isInitialised = false;
//                        _Roughness = ( Grids_GridDouble ) Grid2DSquareCellDoubleFactory.create(
//                                    _File,
//                                    nrows,
//                                    ncols,
//                                    dimensions,
            ...
            if (g.getClass() == Grids_GridDouble.class) {
                ...
                for (chunkRowIndex = 0; chunkRowIndex < nChunkRows; chunkRowIndex++) {
                    ...
                    for (chunkColIndex = 0; chunkColIndex < nChunkCols; chunkColIndex++) {
                        ...
                        ge.addToNotToSwapData(g, chunkID, chunkRowIndex, chunkColIndex, normalChunkNRows, normalChunkNCols, cellDistance);
...
//    }
    ...
    private void metrics1Calculate_All(
        ...
        try {
            ...
            for (p = 0; p <= cellDistance; p++) {
                y = g.getCellYDouble(rowIndex + p, ge.HandleOutOfMemoryErrorTrue);
                yDiff = y - cellY;
                for (q = 1; q <= cellDistance; q++) {
                    //if ( p == 2 && q == 2 ) { int debug2 = 0; }
                    noDataCount = 0.0d;
                    x = g.getCellXDouble(colIndex + q, ge.HandleOutOfMemoryErrorTrue);
                    weight = weights[p][q];
                    xDiff = x - cellX;
            ...
            if (handleOutOfMemoryError) {
                try {
                    ...
                    double thisDistance;
                    for (p = -cellDistance; p <= cellDistance; p++) {
                        thisCellY = g.getCellYDouble(
                                rowIndex + p,
                                ge.HandleOutOfMemoryErrorFalse);
                        for (q = -cellDistance; q
                                <= cellDistance; q++) {
                            thisCellX = g.getCellXDouble(
                                    colIndex + q,
                                    ge.HandleOutOfMemoryErrorFalse);
                    ...
                    HashMap gridChunkMap = new HashMap();
                    Iterator ite = ge.getGrids().iterator();
                    while (ite.hasNext()) {
                        HashSet chunkIDs2 = new HashSet();
                        chunkIDs2.add(chunkID);
                        gridChunkMap.put(ite.next(), chunkIDs2);
                    }
                    gridChunkMap.put(g, chunkIDs);
                } catch (OutOfMemoryError e2) {
                    System.err.println("Unexpected OutOfMemoryError trying to handle OutOfMemoryError in "
                            + "metrics1Calculate_All(Grid2DSquareCellDouble,double,long,long,double,double,"
                            + "double,int,double[][],double[],double[],double[],double[],boolean,ChunkID )");
                    throw e2;
                }
                metrics1Calculate_All(
                        g,
    ...
    private void metrics1Calculate_All(
        ...
        try {
            ...
            for (p = 0; p <= cellDistance; p++) {
                y = g.getCellYDouble(rowIndex + p, ge.HandleOutOfMemoryErrorFalse);
                yDiff = y - cellY;
                for (q = 1; q <= cellDistance; q++) {
                    //if ( p == 2 && q == 2 ) { int debug2 = 0; }
                    noDataCount = 0.0d;
                    ...
                    heights[1] = g.getCell(cellX + yDiff, cellY - xDiff, ge.HandleOutOfMemoryErrorFalse);
                    if (heights[1] == noDataValue) {
                        heights[1] = cellHeight;
                        noDataCount += 1.0d;
                    }
                    heights[2] = g.getCell(cellX - xDiff, cellY - yDiff, ge.HandleOutOfMemoryErrorFalse);
                    if (heights[2] == noDataValue) {
                        heights[2] = cellHeight;
                        noDataCount += 1.0d;
                    }
                    heights[3] = g.getCell(cellX - yDiff, cellY + xDiff, ge.HandleOutOfMemoryErrorFalse);
                    if (heights[3] == noDataValue) {
                        heights[3] = cellHeight;
                        noDataCount += 1.0d;
                    }
            ...
            if (handleOutOfMemoryError) {
                try {
                    ...
                    Iterator _Iterator = ge.getGrids().iterator();
                    ...
                    _Grid2DSquareCell_ChunkIDHashSet_HashMap.put(g, chunkIDs);
                } catch (OutOfMemoryError e2) {
                    System.err.println("Unexpected OutOfMemoryError trying to handle OutOfMemoryError in "
                            + "metrics1Calculate_All(Grid2DSquareCellDouble,double,long,long,double,double,"
                            + "double,int,double[][],double[],double[],double[],double[],boolean,ChunkID )");
    ...
    public Grids_GridDouble[] getMetrics2(
        ...
        try {
            ...
            Grids_GridDouble[] _SlopeAndAspect = null;
