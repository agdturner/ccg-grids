...
public class Grid2DSquareCellDoubleChunkRAF 
     ...
     * @param _ChunkID
     */
    protected Grid2DSquareCellDoubleChunkRAF(
            File file, 
    ...
    protected Grid2DSquareCellDoubleChunkRAF( 
        ...
        initGrid2DSquareCell( grid2DSquareCellDouble );
        if ( grid2DSquareCellDoubleChunk instanceof Grid2DSquareCellDoubleChunkRAF ) {
    ...
    /**
     * Returns a Grid2DSquareCellDoubleChunkRAFIterator for iterating over 
     * the cells in this.
     * @return 
     */
    protected @Override AbstractIterator iterator() {
        return new Grid2DSquareCellDoubleChunkRAFIterator( this );
    }
