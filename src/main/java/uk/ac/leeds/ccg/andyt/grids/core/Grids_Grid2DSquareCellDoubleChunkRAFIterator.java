 ...
 */
public class Grids_Grid2DSquareCellDoubleChunkRAFIterator extends Grids_AbstractIterator {
    
    private RandomAccessFile data;
    
    /** Creates a new instance of Grid2DSquareDoubleIterator */
    public Grids_Grid2DSquareCellDoubleChunkRAFIterator() {}
     ...
     *   to iterate over.
     */
    public Grids_Grid2DSquareCellDoubleChunkRAFIterator(Grids_Grid2DSquareCellDoubleChunkRAF grid2DSquareCellDoubleChunkRAF) {
