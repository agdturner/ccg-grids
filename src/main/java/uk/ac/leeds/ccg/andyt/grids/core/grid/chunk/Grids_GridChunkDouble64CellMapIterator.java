...
/**
 * For iterating through the values in a Grid2DSquareCellDoubleChunk64CellMap
 * instance. The values are not returned in any particular order.
 */
public class Grids_GridChunkDouble64CellMapIterator
        extends Grids_AbstractIterator {

    private TDoubleLongIterator dataIterator;
    ...
    /**
     * Creates a new instance of Grid2DSquareCellDoubleChunk64CellMapIterator
     */
    public Grids_GridChunkDouble64CellMapIterator() {
    }

    /**
     * Creates a new instance of Grid2DSquareCellDoubleChunk64CellMapIterator
     *
     * @param grid2DSquareCellDoubleChunk64CellMap The
     * Grid2DSquareCellDoubleChunk64CellMap to iterate over.
     */
    public Grids_GridChunkDouble64CellMapIterator(
        ...
        iteratorIndex = 0L;
        Grids_GridDouble grid2DSquareCellDouble = grid2DSquareCellDoubleChunk64CellMap.getGrid();
        this.noDataValue = grid2DSquareCellDouble.getNoDataValue(false);
        this.numberOfCells = ((long) grid2DSquareCellDouble.getChunkNRows(grid2DSquareCellDoubleChunk64CellMap.ChunkID,
                ge.HandleOutOfMemoryErrorFalse)
                * (long) grid2DSquareCellDouble.getChunkNCols(grid2DSquareCellDoubleChunk64CellMap.ChunkID,
                        ge.HandleOutOfMemoryErrorFalse));
        try { // In case empty!
