 ...
 * TIntLongHashMap. The maximum size of this
 * Grids_AbstractGrid2DSquareCellIntChunk is 64 cells. TODO: Adjudicate when
...
public class Grids_Grid2DSquareCellIntChunk64CellMap
     ...
     *
     *
     * @param gridChunk The Grids_AbstractGrid2DSquareCellIntChunk this is
     * constructed from.
     * @param _ChunkID The ID this will have.
     */
    protected Grids_Grid2DSquareCellIntChunk64CellMap(
        ...
        this.ChunkID = _ChunkID;
        Grids_Grid2DSquareCellInt g
                = gridChunk.getGrid2DSquareCellInt();
        initGrid(g);
    ...
    double getMedianDouble() {
        ...
        return ((Grids_Grid2DSquareCellInt) getGrid()).getNoDataValue(true);
    }
    ...
    /**
     * Returns a Grids_Grid2DSquareCellIntChunk64CellMapIterator for iterating
