...
public class Grid2DSquareCellIntFactory
    ...
    public Grid2DSquareCellIntFactory(
        ...
        this(_Directory,
                64,
                64,
                new Grid2DSquareCellIntChunkArrayFactory(),
                _Grids_Environment,
                _HandleOutOfMemoryError);
    }
...
* @param _Directory A "workspace _Directory" for storing temporary files and
     ...
     * @param _Grid2DSquareCellIntChunkFactory The AbstractGrid2DSquareCellIntChunkFactory
    ...
    public Grid2DSquareCellIntFactory(
        ...
        if (_Grid2DSquareCellIntChunkFactory.getClass()
                == Grid2DSquareCellIntChunk64CellMapFactory.class) {
     ...
     *   AbstractGrid2DSquareCellIntChunkFactory for creating chunks.
     * @param nrows The Grid2DSquareCellInt nrows.
     * @param ncols The Grid2DSquareCellInt ncols.
     * @param _Dimensions
     * @param _Grids_Environment
    ...
    public Grid2DSquareCellInt create(
            ...
            Grids_Environment _Grids_Environment,
            boolean _HandleOutOfMemoryError) {
        return new Grid2DSquareCellInt(
                gridStatistics,
                _Directory,
