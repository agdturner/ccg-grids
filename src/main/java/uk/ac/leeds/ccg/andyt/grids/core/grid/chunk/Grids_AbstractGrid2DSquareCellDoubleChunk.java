...
public abstract class Grids_AbstractGrid2DSquareCellDoubleChunk
    ...
    protected Grids_AbstractGrid2DSquareCellDoubleChunk(){}
    
    protected Grids_AbstractGrid2DSquareCellDoubleChunk(Grids_Environment ge){
        super(ge);
    }
     ...
     * @return ( Grids_Grid2DSquareCellDouble ) this._Grid2DSquareCell.ge.
     */
    public Grids_Grid2DSquareCellDouble getGrid2DSquareCellDouble(
        ...
        try {
            ...
            if (handleOutOfMemoryError) {
                ...
                ge.init_MemoryReserve(this.getGrid(),
                        this.ChunkID,
    ...
    protected Grids_Grid2DSquareCellDouble getGrid2DSquareCellDouble() {
        return (Grids_Grid2DSquareCellDouble) this.getGrid();
    }
    ...
    public double getCell(
        ...
        try {
            ...
            if (handleOutOfMemoryError) {
                ge.clear_MemoryReserve();
                if (ge.swapToFile_Grid2DSquareCellChunkExcept_AccountDetail(
                        chunkID,
                        false) == null) {
                    ge.swapToFile_Grid2DSquareCellChunk_AccountDetail(
                            false);
                }
                ge.init_MemoryReserve(this.ChunkID,
                        handleOutOfMemoryError);
                return getCell(
                        chunkCellRowIndex,
                        chunkCellColIndex,
