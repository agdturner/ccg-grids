 ...
 */
public class Grids_GridChunkDoubleArrayIterator extends Grids_AbstractIterator {
     ...
     */
    public Grids_GridChunkDoubleArrayIterator(Grids_GridChunkDoubleArray grid2DSquareCellDoubleChunkArray) {
        this.data = grid2DSquareCellDoubleChunkArray.getData();
        this.chunkRowIndex = 0;
        this.chunkColIndex = 0;
        Grids_GridDouble grid2DSquareCellDouble = grid2DSquareCellDoubleChunkArray.getGrid();
