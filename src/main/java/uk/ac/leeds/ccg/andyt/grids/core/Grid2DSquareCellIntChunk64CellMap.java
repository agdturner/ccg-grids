 ...
 * TIntLongHashMap. The maximum size of this AbstractGrid2DSquareCellIntChunk is 
 * 64 cells.
 * TODO:
...
public class Grid2DSquareCellIntChunk64CellMap
    ...
    protected Grid2DSquareCellIntChunk64CellMap(
        ...
        long nChunkCells =
                ( long ) grid2DSquareCellInt._ChunkNRows *
                ( long ) grid2DSquareCellInt._ChunkNCols;
        if ( nChunkCells <= 64 ) {
            initData();
        } else {
            throw new Error(
     ...
     * AbstractGrid2DSquareCellIntChunk this is constructed from.
     * @param _ChunkID The ChunkID this will have.
     */
    protected Grid2DSquareCellIntChunk64CellMap(
    ...
    protected @Override int setCell( 
        ...
        int position = 
                ( chunkCellRowIndex * grid2DSquareCellInt._ChunkNCols ) + 
                chunkCellColIndex;
    ...
    /**
     * Returns a Grid2DSquareCellIntChunk64CellMapIterator for iterating over
     * the cells in this.
     * @return 
     */
    protected @Override AbstractIterator iterator() {
        return new Grid2DSquareCellIntChunk64CellMapIterator( this );
    }
