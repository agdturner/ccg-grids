 ...
 */
public class Grids_GridChunkInt64CellMapFactory
        extends Grids_AbstractGridChunkIntFactory {

    /**
     * Creates a new Grid2DSquareCellIntChunk64CellMapFactory.
     */
    public Grids_GridChunkInt64CellMapFactory() {
    }

    @Override
    public Grids_GridChunkInt64CellMap createGridChunkInt() {
        return new Grids_GridChunkInt64CellMap();
    }
