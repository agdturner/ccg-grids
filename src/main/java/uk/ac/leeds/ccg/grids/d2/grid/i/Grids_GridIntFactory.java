 ...
 * @version 1.0.0
 */
public class Grids_GridIntFactory extends Grids_GridFactory {
     ...
     * gridChunkIntFactory
     */
    public Grids_ChunkIntFactorySinglet gridChunkIntFactory;
...
//    public Grids_GridChunkIntArrayFactory ChunkIntArrayFactory;
     ...
     */
    public Grids_ChunkIntFactory defaultGridChunkIntFactory;
     ...
     */
    public Grids_GridIntFactory(Grids_Environment e, IO_Cache fs,
            Grids_ChunkIntFactorySinglet gcif,
            Grids_ChunkIntFactory dgcif, int chunkNRows,
            int chunkNCols) {
        super(e, fs, chunkNRows, chunkNCols, null);
        gridChunkIntFactory = gcif;
        defaultGridChunkIntFactory = dgcif;
        stats = new Grids_GridIntStatsNotUpdated(e);
     ...
     */
    public void setDefaultChunkFactory(Grids_ChunkIntFactory cf) {
...
//                gridChunkIntFactory, nRows, nCols, dim);
     ...
     * @param cf The preferred Grids_ChunkIntFactory for creating chunks that
 the constructed Grid is to be made of.
    ...
    public Grids_GridInt create(Grids_StatsInt stats,
            Grids_ChunkIntFactory cf, long nRows, long nCols,
    ...
    public Grids_GridInt create(Grids_Grid g, long startRow, long startCol,
            ...
            throws IOException, ClassNotFoundException, Exception {
        return create(new Grids_GridIntStatsNotUpdated(env), g,
 ...
 the constructed Grid is to be made of.
    ...
    public Grids_GridInt create(Grids_StatsInt stats, Grids_Grid g,
            Grids_ChunkIntFactory cf, long startRow, long startCol, long endRow,
     ...
     */
    public Grids_GridInt create(Grids_StatsInt stats,
            IO_Path gridFile, Grids_ChunkIntFactory cf,
