...
/**
 * A factory for constructing {@link Grids_ChunkIntFactorySinglet} instances.
 *
 * @author Andy Turner
 * @version 1.0.0
 */
public class Grids_ChunkIntFactorySinglet extends Grids_ChunkIntFactory {
     ...
     */
    protected Grids_ChunkIntFactorySinglet() {
    }
     ...
     */
    public Grids_ChunkIntFactorySinglet(int dv) {
        defaultValue = dv;
    }
