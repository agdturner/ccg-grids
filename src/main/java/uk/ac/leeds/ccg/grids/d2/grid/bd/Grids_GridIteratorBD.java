...
import uk.ac.leeds.ccg.grids.d2.chunk.bd.Grids_ChunkIteratorBDArrayOrMap;
...
import uk.ac.leeds.ccg.grids.d2.chunk.bd.Grids_ChunkIteratorBDSinglet;
 ...
 * @version 1.0.0
 */
public class Grids_GridIteratorBD extends Grids_GridIterator {
     ...
     */
    public Grids_GridIteratorBD(Grids_GridBD g) throws IOException,
    ...
    protected final void initChunkIterator() {
        if (chunk instanceof Grids_ChunkBDArray) {
            chunkIterator = new Grids_ChunkIteratorBDArrayOrMap(
                    (Grids_ChunkBDArray) chunk);
        } else if (chunk instanceof Grids_ChunkBDMap) {
            chunkIterator = new Grids_ChunkIteratorBDArrayOrMap(
                    (Grids_ChunkBDMap) chunk);
        } else {
            chunkIterator = new Grids_ChunkIteratorBDSinglet(
    ...
    @Override
    public Grids_ChunkIteratorBDArrayOrMap getChunkIterator() {
        return (Grids_ChunkIteratorBDArrayOrMap) chunkIterator;
    }
}
