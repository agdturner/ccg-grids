...
import uk.ac.leeds.ccg.grids.d2.chunk.b.Grids_ChunkBooleanFactorySinglet;
 ...
 * @version 1.0.0
 */
public class Grids_GridBooleanFactory extends Grids_GridFactory {
     ...
     * factory
     */
    public Grids_ChunkBooleanFactory factory;

    /**
     * stats
     */
    public Grids_GridBooleanStats stats;
    
    /**
     * gridChunkBooleanFactory
     */
    public Grids_ChunkBooleanFactorySinglet gridChunkBooleanFactory;
...
//    public Grids_GridChunkBooleanArrayFactory ChunkBooleanArrayFactory;
     ...
     */
    public Grids_ChunkBooleanFactory defaultGridChunkBooleanFactory;

    /**
     * {@link #dim} is set to {@code null}. {@link #stats} is set to
     * {@code new Grids_GridBooleanStatsNotUpdated(e)}.
     *
     ...
     */
    public Grids_GridBooleanFactory(Grids_Environment e, IO_Cache fs,
            Grids_ChunkBooleanFactory factory, int chunkNRows, int chunkNCols) {
        this(e, fs, factory, chunkNRows, chunkNCols, null,
                new Grids_GridBooleanStatsNotUpdated(e));
    }
    ...
    public Grids_GridBooleanFactory(Grids_Environment e, IO_Cache fs,
            Grids_ChunkBooleanFactory factory, int chunkNRows, int chunkNCols,
            Grids_Dimensions dimensions, Grids_GridBooleanStats stats) {
    ...
    public Grids_GridBoolean create(long nRows, long nCols,
        ...
        return create(new Grids_GridBooleanStatsNotUpdated(env), factory, nRows,
                nCols, dimensions);
    }
     ...
     * Create a grid with all values set to {@code null}.
     *
     * @param stats The type of Grids_GridBooleanStats to accompany the returned
 grid.
     ...
     * @throws java.io.IOException If encountered.
     */
    public Grids_GridBoolean create(Grids_GridBooleanStats stats,
            Grids_ChunkBooleanFactory cf, long nRows, long nCols,
            Grids_Dimensions dimensions) throws IOException, Exception {
     ...
     * {@code new Grids_GridBooleanStatsNotUpdated(env)}.
     *
    ...
    public Grids_GridBoolean create(Grids_Grid g,
        ...
        return create(new Grids_GridBooleanStatsNotUpdated(env), g,
     ...
     * @param stats The type of Grids_GridBooleanStats to accompany the returned
 grid.
     * @param cf The preferred {@link Grids_ChunkBooleanFactory} for creating
     ...
     */
    public Grids_GridBoolean create(Grids_GridBooleanStats stats,
            Grids_Grid g, Grids_ChunkBooleanFactory cf, long startRow,
     ...
     * {@code new Grids_ChunkBooleanFactory()}.
     *
    ...
    public Grids_GridBoolean create(IO_Path gridFile,
            long startRow, long startCol, long endRow, long endCol)
            throws IOException, ClassNotFoundException, Exception {
        return create(new Grids_GridBooleanStatsNotUpdated(env), gridFile,
                defaultGridChunkBooleanFactory, startRow, startCol, endRow,
                endCol);
    }
     ...
     */
    public Grids_GridBoolean create(Grids_GridBooleanStats stats,
            IO_Path gridFile, Grids_ChunkBooleanFactory cf,
            long startRow, long startCol, long endRow, long endCol)
            throws IOException, ClassNotFoundException, Exception {
        Grids_GridBoolean r = new Grids_GridBoolean(getStats(stats),
    ...
    /**
     * @param stats
     * @return A new Grids_GridBooleanStats of the same type for use.
     */
    private Grids_GridBooleanStats getStats(Grids_GridBooleanStats stats) {
        if (stats instanceof Grids_GridBooleanStatsNotUpdated) {
            return new Grids_GridBooleanStatsNotUpdated(env);
        } else {
            return new Grids_GridBooleanStats(env);
        }
    }
     ...
     */
    public void setDefaultChunkFactory(Grids_ChunkBooleanFactory cf) {
