 ...
 * @version 1.0.0
 */
public class Grids_ChunkStatsDouble extends Grids_StatsDouble {
     ...
     */
    public Grids_ChunkStatsDouble(Grids_Environment ge, Grids_ChunkDouble c) {
        super(ge);
        this.c = c;
    }
    ...
    public void update() throws IOException, Exception, ClassNotFoundException {
        ...
        if (c instanceof Grids_ChunkDoubleSinglet) {
            ...
            Grids_ChunkIteratorDoubleArrayOrMap ite;
            ite = new Grids_ChunkIteratorDoubleArrayOrMap(
