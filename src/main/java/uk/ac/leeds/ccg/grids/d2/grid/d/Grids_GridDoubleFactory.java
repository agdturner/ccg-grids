 ...
 * @version 1.0.0
 */
public class Grids_GridDoubleFactory extends Grids_GridFactory {
     ...
     */
    public Grids_ChunkDoubleFactorySinglet gridChunkDoubleFactory;
...
//    public Grids_GridChunkDoubleArrayFactory ChunkDoubleArrayFactory;
     ...
     */
    public Grids_ChunkDoubleFactory defaultGridChunkDoubleFactory;
     ...
     */
    public Grids_GridDoubleFactory(Grids_Environment e, IO_Cache fs,
            Grids_ChunkDoubleFactorySinglet gcdf,
            Grids_ChunkDoubleFactory dgcdf, int cnr, int cnc) {
        this(e, fs, gcdf, dgcdf, -Double.MAX_VALUE, cnr, cnc,
                null, new Grids_GridDoubleStatsNotUpdated(e));
    }
     ...
     */
    public Grids_GridDoubleFactory(Grids_Environment ge, IO_Cache fs,
            Grids_ChunkDoubleFactorySinglet gcdf,
            Grids_ChunkDoubleFactory dgcdf, double ndv, int chunkNRows,
     ...
     */
    public void setDefaultChunkFactory(Grids_ChunkDoubleFactory cf) {
    ...
    public Grids_GridDouble create(long nRows, long nCols,
        ...
        return create(new Grids_GridDoubleStatsNotUpdated(env),
     ...
     * grid.
     * @param cf The Grids_ChunkDoubleFactory for creating chunks that the
 constructed Grid is to be made of.
     ...
     * @throws java.lang.ClassNotFoundException If encountered.
     */
    public Grids_GridDouble create(Grids_GridDoubleStats stats,
            Grids_ChunkDoubleFactory cf, long nRows, long nCols,
            Grids_Dimensions dimensions) throws IOException,
            ClassNotFoundException, Exception {
    ...
    public Grids_GridDouble create(Grids_Grid g,
        ...
        return create(new Grids_GridDoubleStatsNotUpdated(env), g,
     ...
     */
    public Grids_GridDouble create(Grids_GridDoubleStats stats,
            Grids_Grid g, Grids_ChunkDoubleFactory cf,
            long startRow, long startCol, long endRow, long endCol)
            throws IOException, ClassNotFoundException, Exception {
        Grids_GridDouble r = new Grids_GridDouble(getStats(stats), store,
     ...
     */
    public Grids_GridDouble create(Grids_GridDoubleStats stats,
            IO_Path gridFile, Grids_ChunkDoubleFactory cf,
            long startRow, long startCol, long endRow, long endCol)
            throws IOException, ClassNotFoundException, Exception {
        Grids_GridDouble r = new Grids_GridDouble(getStats(stats), store,
