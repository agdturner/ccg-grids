 ...
 * @version 1.0.0
 */
public class Grids_ChunkBinaryFactorySinglet extends Grids_ChunkBinaryFactory {
     ...
     */
    protected Grids_ChunkBinaryFactorySinglet() {
    }
     ...
     */
    public Grids_ChunkBinaryFactorySinglet(boolean dv) {
        defaultValue = dv;
    }
